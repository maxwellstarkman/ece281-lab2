...
architecture test_bench of sevenseg_decoder_tb is 
    ...
    -- 1. Declare the component of your top-level design unit under test (UUT)
    ...
    -- 2. Declare signals needed to stimulate the UUT inputs
...
begin
    ...
    begin
        ...
        -- Optional: Loop through all values to see them in the waveform
